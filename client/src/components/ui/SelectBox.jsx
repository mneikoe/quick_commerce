...
const SelectBox = ({
  ...
  const [isOpen, setIsOpen] = useState(false); // State to manage open/close of select box
    ...
    <div className="w-full">
      ...
      <div className="relative">
        <select
          ...
          onChange={onChange}
          required={required}
          onClick={toggleDropdown} // Toggle on click of select box
        ...
        {/* Show ChevronDown when the dropdown is closed, ChevronUp when opened */}
